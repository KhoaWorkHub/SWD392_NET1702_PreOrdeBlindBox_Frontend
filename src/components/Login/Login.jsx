        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <input
              ...
              className={`w-full h-12 px-4 border ${errors.email ? 'border-red-500' : 'border-gray-200'} rounded focus:outline-none focus:border-gray-400`}
            />
            {errors.email && (
          ...
          <div className="mb-3 relative">
            <input
              ...
              className={`w-full h-12 px-4 border ${errors.password ? 'border-red-500' : 'border-gray-200'} rounded focus:outline-none focus:border-gray-400`}
            />
            <button
              type="button"
